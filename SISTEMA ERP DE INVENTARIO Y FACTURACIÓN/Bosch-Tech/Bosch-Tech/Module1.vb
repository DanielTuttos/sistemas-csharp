...
Module Module1
    ...
    Public con As New SqlConnection("Data Source=.;Initial Catalog=bosch-tech;User ID=sa;Password=123")
    Public Function opendb()

        If conn.State = 1 Then conn.Close()
        conn.Open("Provider=SQLOLEDB;Persist Security Info=False;User ID=sa;password=123;Initial Catalog=bosch-tech;Data Source=.")
        Return 0
    End Function
