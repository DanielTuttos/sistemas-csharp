...
Public Class SubRPTsales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PharmacyManagementSystem.SubRPTsales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSubRPTsales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubRPTsales = New SubRPTsales()
        rpt.Site = Me.Site
        Return rpt
    End Function
