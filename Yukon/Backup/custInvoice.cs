...
namespace Yukon {
    ...
    public class custInvoice : DataSet {
        ...
        protected custInvoice(SerializationInfo info, StreamingContext context) {
        ...
        public class CustomerDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public CustomerRow AddCustomerRow(string Address, string City, System.Double CRate, string CustomerStatus, string Email, string Fax, string FirstName, string LastName, int Phone, int Zipcode) {
